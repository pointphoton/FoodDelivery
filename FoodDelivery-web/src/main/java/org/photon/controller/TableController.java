...
import org.photon.lazymodel.repository.Products;
   ...
   private List<Category> categoryList;
    ...
    public void init() {
        ...
        filter   = new ProductFilter();
          ...
          // products=sessionEJB.filterProducts(filter);
      ...
      lazyDataModel=  new LazyDataModel<Product>() {
			...
			public List<Product> load(int first, int pageSize,
				...
				filter.setPropriedadeOrdenacao(sortField);
                                setRowCount(sessionEJB.quantityFilter(filter));
				return sessionEJB.filterProducts(filter);
			    ...
			    public Product getRowData(String rowKey) {
			        ...
			        for(Product product : sessionEJB.filterProducts(filter)) {
